    ...
    <template v-if="!successApply">
      <Form :rules="ruleResetPassword" :model=formResetPassword ref="formResetPassword">
        <Form-item prop="email">
          ...
          <Icon custom="iconfont icon-4dianziyoujian" slot="prepend"></Icon>
          </Input>
        </Form-item>
        <Form-item prop="captcha" style="margin-bottom:10px">
          <div class="oj-captcha">
            <div class="oj-captcha-code">
              ...
              <Icon type="ios-bulb" slot="prepend"></Icon>
              </Input>
            </div>
...
<style scoped lang="less">
  @import '../../../../assets/fonts/fontlib/iconfont.css';
  .container {
    width: 450px;
    margin: auto;
    .center {
    ...
    @font-face {
      ...
      src: url('/static/fonts/fontlib/iconfont.ttf') format('ttf');
    }
    
    .hyper-font {
      font-family: "hyper-pro" !important;
    }
