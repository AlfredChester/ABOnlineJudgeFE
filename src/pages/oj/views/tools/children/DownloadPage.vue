...
export default {
      ...
      Downloads: {
        ...
        Listening: {
          ...
          data: [
            ...
            {
              title: '8A初中英语听力训练 zip压缩包',
              src: requireListening('8A')
            }
          ],
          pdfData: []
        },
        ...
        Chinese: {
          ...
          pdfData: [
            ...
            requirePdf('《孙权劝学》课件（全）', 29),
            requirePdf('《孙权劝学》家默卷', 2),
            requirePdf('《卖油翁》文常及翻译', 13),
            requirePdf('《爱莲说》翻译', 10),
            requirePdf('《陋室铭》翻译', 9),
            requirePdf('《陋室铭》家默卷', 1),
            requirePdf('《活板》 翻译部分', 25),
            requirePdf('《答谢中书书》文常及翻译部分', 10),
  ...
  mounted() {
    console.log('[oj/DownloadPage.vue] Loaded DownloadPage.vue')
