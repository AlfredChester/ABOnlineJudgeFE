            ...
            <Panel :padding="20" shadow>
              ...
              <div slot="extra">
                <Tag type="dot" :color="countdownColor">
                  <span id="countdown">{{countdown === 'Ended' ? $t('m.Ended') : countdown}}</span>
                </Tag>
              </div>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            render: (h, params) => {
              var untranslatedText = this.$i18n.t('m.' + params.row.contest_type ? params.row.contest_type.replace(' ', '_') : '')
              return h('span', untranslatedText === 'Public' ? this.$i18n.t('m.Public') : this.$i18n.t('m.Password_Protected'))
            }
          },
          {
    ...
    methods: {
      ...
      checkPassword () {
        if (this.contestPassword === '') {
          this.$error(this.$i18n.t('m.Password_cant_be_empty'))
          return
        }
