<template>
  <Panel shadow>
    ...
    <div slot="extra" style="vertical-align: middle;">
      <screen-full :height="18" :width="18" class="screen-full"></screen-full>
      <Poptip trigger="hover" placement="left-start" style="cursor:pointer;">
        <Icon type="md-settings" size="20" style="margin-bottom: 5px;"></Icon>
