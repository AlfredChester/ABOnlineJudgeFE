  ...
  <div class="view">
    <Panel :title="$t('m.User_User') ">
      ...
      <el-table
        ...
        <el-table-column prop="admin_type" :label="$t('m.User_Type')">
          <template slot-scope="scope">
            {{ scope.row.admin_type === 'Regular User' ? $t('m.Regular_User') : (scope.row.admin_type === 'Admin' ? $t('m.Admin') : $t('m.Super_Admin')) }}
          </template>
        </el-table-column>
    ...
    <Panel>
      <span slot="title">{{$t('m.Import_User')}}
        <el-popover placement="right" trigger="hover">
          <p>{{$t('m.Import_User_Help_1')}}<a
            href="http://docs.onlinejudge.me/#/onlinejudge/guide/import_users">{{$t('m.Import_User_Help_2')}}</a>{{$t('m.Import_User_Help_3')}}</p>
      ...
      <template v-else>
        ...
        <div class="panel-options">
          <el-button type="primary" size="small"
                     ...
                     @click="handleUsersUpload">{{$t('m.Import_All_User')}}
          </el-button>
    ...
    <Panel :title="$t('m.Generate_User')">
      <el-form :model="formGenerateUser" ref="formGenerateUser">
        <el-row type="flex" justify="space-between">
          <el-col :span="4">
            <el-form-item :label="$t('m.Prefix_Number')" prop="prefix">
              <el-input v-model="formGenerateUser.prefix" :placeholder="$t('m.Prefix_Number')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item :label="$t('m.Suffix_Number')" prop="suffix">
              <el-input v-model="formGenerateUser.suffix" :placeholder="$t('m.Suffix_Number')"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item :label="$t('m.ID_Start_Number')" prop="number_from" required>
              <el-input-number v-model="formGenerateUser.number_from" style="width: 100%"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item :label="$t('m.ID_End_Number')" prop="number_to" required>
        ...
        <el-form-item>
          <el-button type="primary" @click="generateUser" icon="el-icon-fa-users" :loading="loadingGenerate">{{$t('m.Gen_and_export')}}
          </el-button>
    ...
    <el-dialog :title="$t('m.User_Info')" :visible.sync="showUserDialog" :close-on-click-modal="false">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('m.Problem_Permission')">
              <el-select v-model="user.problem_permission" :disabled="user.admin_type!=='Admin'">
                <el-option :label="$t('m.No_Question_Authority')" value="None"></el-option>
                <el-option :label="$t('m.Own_Question_Authority')" value="Own"></el-option>
                <el-option :label="$t('m.All_Question_Authority')" value="All"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <span slot="footer" class="dialog-footer">
        <cancel @click.native="showUserDialog = false">{{$t('m.Cancel_i18n')}}</cancel>
