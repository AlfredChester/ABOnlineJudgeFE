export const m = {
  ...
  // ProfileSetting.vue
  SureToDiscard: '確定要放棄編輯嗎?',
  File_Size_ExceedMax: '文件大小超過最大限制',
  File_Type_NSP: '不支持的檔案類型',
  School: '學校',
  Major: '系所',
  Blog: '部落格',
  DropOrClick: '拖放到此處，或按一下以手動選擇',
  YourAvatarWillBeSetTo: '你的頭像將被設置為',
  Upload: '上傳',
  Avatar_Setting: '大頭貼設定',
  Profile_Setting: '個人資訊設定',
  // SecuritySetting.vue
  SureToRevokeSession: '確定要登出此 Session 嗎?',
  SureToCloseTFA: '雙因素身份驗證是保護您的帳戶的强大工具，您確定要關閉它嗎?',
  Confirm_i18n: '確認',
  Open_i18n: '開啟',
  Close_i18n: '關閉',
  Have_Enabled_TFA: '您已經啟用了雙因素身份驗證',
  Enter_The_Code: '請輸入驗證碼',
  OS: '操作系統 :',
  Browser: '瀏覽器 :',
  LastActivity: '最後活動 :',
  Revoke: '登出',
  ...
  Profile_Settings: '個人資訊設定',
  Security_Settings: '安全設定',
  Account_Settings: '帳號設定',
  JumpedToProfileSt: '已經跳轉到個人設置頁面,請在這個頁面修改頭像',
  Change_Avatar: '更改頭像',
  // Login.vue
  LoginUsername: '使用者名稱',
  LoginPassword: '密碼',
  ...
  ABOJs_Tos: 'ABOJ的服務條款',
  ABOJs_Privacy_Policy: '隱私政策',
  And: '和',
  Must_Agree_Tos: '您必須先閱讀並同意我們的服務條款和隱私政策',
  Invalid_Captcha: '驗證碼不能為空',
  Invalid_Password: '密碼應包含6~20位數位和字母',
  Invalid_Email: '非法的電子郵寄地址',
  Username_Cannot_Be_Empty: '使用者名稱不能為空',
  ...
  // UserHome.vue
  Regenerate: '重新生成',
  RegenerateContent1: '如果您發現以下問題id不存在,',
  RegenerateContent2: '可以試試按一下按鈕',
  ...
  KeyWord: '關鍵字',
  // form.js
  Please_Validate_Error_Fields: '請驗證錯誤欄位',
  // ThanksPage.vue
  ThanksForSupport: '感謝您對本網站的支持和理解',
  Special_Thanks: '特別感謝',
  TechSupport: '技術支援',
  EconomicSupport: '經濟支持',
  If_you_want_to_support: '如果我的網站幫到了您，您可以選擇支持一下本站，讓網站越做越好',
  // AccountSetting.vue
  Old_Password: '舊密碼',
  New_Password: '新密碼',
  Current_Password: '當前密碼',
  Confirm_New_Password: '確認新密碼',
  Password_No_Change: '密碼沒有變更',
  Old_Email: '舊電子郵箱',
  New_Email: '新電子郵箱',
  Two_Factor_Auth: '雙因素認證',
  Relogin_In5s: '您需要在5秒後再次登入',
  ListeningPage: '聽力頁面',
  DownloadPage: '資源下載集合',
  Download_i18n: '下載',
  Learning_Materials: '學習資料'
}
