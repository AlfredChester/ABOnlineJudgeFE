...
function init() {
  ...
  menu = $(`<div id='menu'> <h3>菜单</h3>
    ...
    <fieldset>
        ...
        <p>
            <a href='https://github.com/caibyte/DuckchessOnline'>
                github链接
            </a>
            <a href='http://alfredoj.natapp1.cc/static/games/DuckchessOnline/LICENSE.html'>
                MIT条款
            </a>
        </p>
    </fieldset>
    <fieldset>
        <legend>规则</legend>
        <a href='https://www.luogu.com.cn/problem/P5380'>点我查看</a>
    </fieldset>
    </div>`)
